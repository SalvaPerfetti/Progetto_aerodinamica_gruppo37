...
if err <= toll
    NumTotPannelli=(config.ChordwiseDiscr(itSpan)*config.SemiSpanwiseDiscr(itSpan))*2;
...
title('Errore percentuale al variare del numero totale di pannelli Boeing 737')
