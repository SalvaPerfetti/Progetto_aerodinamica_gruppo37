function [ControlPoints, InducedPoints, Normals, InfiniteVortices, Vortices, internalMesh, WingExtremes2Export] = createStructure(config, iCorpo,N)
...
InfiniteVorticesLength = N * config.RootChord(iCorpo);
