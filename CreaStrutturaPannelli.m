...
NPannelli = length(Corpo_Input.x)-1; % ricordo che length da il max tra le righe e le colonne
...
L2G_TransfMatrix = zeros(NPannelli, 2, 2); % trasformazione da locale a globale, per ogni pannello ho una matrice 2x2
