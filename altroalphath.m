...
y_lm = [0, 0.0122, 0.0166, 0.0201, 0.0231, 0.0261, 0.0318, 0.0338, 0.0355, ...
        ...
        0.0028, 0.002, 0.0009, 0];

% Parametri
L = 1; % Lunghezza della corda
s = x_corda - 0.5; % Trasformazione da x a s (centrato a metà corda)

% Calcolo della derivata numerica di ylm rispetto a s
dylm_ds = gradient(y_lm, s); % Derivata numerica di ylm rispetto a s
